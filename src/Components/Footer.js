        ...
        <div>
            <footer className="footer footer-center p-10 bg-slate-400 text-primary-content">
                <div>
                    ...
                    Design and Implemented by <a className='text-primary hover:text-black' href="https://portfolio-rakibul.netlify.app/" target="_blank" rel='noReferrer'>Rakibul Hasan</a>
                    </p> 
