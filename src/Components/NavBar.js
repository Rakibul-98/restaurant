...
const NavBar = () => {
    ...
    return (
        <div className="flex justify-around py-5 text-lg relative">
            <div className="">
                <a href='/' className="">logo</a>
            </div>
            <div className="font-semibold">
                <div className='md:hidden'>
                    <label className="btn btn-circle bg-transparent border-0 swap swap-rotate absolute right-10 top-2 hover:bg-error">
                ...
                <ul className="md:flex hidden nav_links_md">
                    {
                        navLinks.map(l=>
                        <li className='lg:ml-10 ml-5 hover:text-error'>
                            <a href={l.link}>{l.name}</a>
                        </li>)
                    }
                </ul>
